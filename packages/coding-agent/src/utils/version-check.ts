import { getNeosantaraUserAgent } from "./neosantara-user-agent.js";

const LATEST_VERSION_URL = "https://api.neosantara.xyz/api/latest-version";
...
export async function getLatestPiRelease(
	...
	const response = await fetch(LATEST_VERSION_URL, {
		headers: {
			"User-Agent": getNeosantaraUserAgent(currentVersion),
