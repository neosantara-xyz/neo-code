...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@neosantara/tui";
...
const THEME_KEY = Symbol.for("@neosantara/code:theme");
const THEME_KEY_OLD = Symbol.for("@neosantara/code:theme");
...
export function getSettingsListTheme(): import("@neosantara/tui").SettingsListTheme {
	return {
