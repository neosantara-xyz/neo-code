...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} <command> --help          Show help for install/remove/uninstall/update/list/login
...
${chalk.bold("Options:")}
  ...
  --no-context-files, -nc        Disable AGENTS.md discovery and loading
...
${chalk.bold("Examples:")}
  # Log in once with Neosantara device authorization
  ${APP_NAME} login
  ...
  # Use different Neosantara model
  ${APP_NAME} --provider neosantara --model claude-4.5-sonnet "Help me refactor this code"

  # Use model with provider prefix (no --provider needed)
  ${APP_NAME} --model neosantara/grok-4.1-fast-non-reasoning "Help me refactor this code"

  # Use model with thinking level shorthand
  ${APP_NAME} --model claude-4.5-sonnet:high "Solve this complex problem"

  # Limit model cycling to specific models
  ${APP_NAME} --models grok-4.1-fast-non-reasoning,claude-4.5-sonnet,gemini-3-flash

  # Limit to a specific provider with glob pattern
  ${APP_NAME} --models "neosantara/*"

  # Cycle models with fixed thinking levels
  ${APP_NAME} --models claude-4.5-sonnet:high,gemini-3-flash:low
