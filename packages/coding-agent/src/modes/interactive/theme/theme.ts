...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@neosantara-xyz/tui";
...
const THEME_KEY = Symbol.for("@neosantara-xyz/code:theme");
const THEME_KEY_OLD = Symbol.for("@neosantara-xyz/code:theme");
...
export function getSettingsListTheme(): import("@neosantara-xyz/tui").SettingsListTheme {
	return {
